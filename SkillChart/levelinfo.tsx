...
export const levelDescriptions: LevelDescription[] = [
...

  {
    ...
    level: "1",
    description: "Influence & Decision Making M3\n\n🎯 Your team trusts you as a subject matter expert of your domain.\n\n🎯 You make clear, informed decisions about the day-to-day work of your team with minimal support.\n\n🎨 You guide your team to balance user, business, and quality goals.",
    role: "Managers",
  },
  {
    skill: "Influence & Decision Making",
    level: "2",
    description: "Influence & Decision Making M4\n\n🎯 Teams across the company consult with you as a subject matter expert in your domain.\n\n🎯 You make decisions that affect the longer-term direction of your team(s), and incorporate input from your manager and stakeholders.\n\n🎨 You influence adjacent teams through a strong user-centered perspective.",
    role: "Managers",
  },
  {
    skill: "Influence & Decision Making",
    level: "3",
    description: "Influence & Decision Making M5\n\n🎯 People outside of Figma are starting to seek you out for advice, mentorship, and/or functional expertise.\n\n🎯 You strategically identify areas where work/investment is not paying off and direct your teams to pivot accordingly.\n\n🎨 You shape product strategy through design insights and cross-team collaboration.",
    role: "Managers",
  },
  {
    skill: "Influence & Decision Making",
    level: "4",
    description: "Influence & Decision Making M6\n\n🎯 You work across the company to inspire Figmates to your vision, resolve ambiguity, and streamline execution for your organization.\n\n🎯 You are developing in your thought leadership and can solve complex and ambiguous problems that impact the company's long-term success.",
    role: "Managers",
  },
  {
    skill: "Influence & Decision Making",
    level: "5",
    description: "Influence & Decision Making E1\n\n🎯 You actively influence other executives and represent the organization on matters of great significance.\n\n🎯 You are broadly recognized as a thought leader both internally and externally.\n\n🎨 You shape company-wide strategy grounded in customer and design excellence.",
    role: "Managers",
  },
  {
    skill: "Influence & Decision Making",
  ...
  },
  {
    ...
    level: "1",
    description: "Achieve Business Results M3\n\n🎯 You work with leaders in your organization to define and communicate team goals and metrics.\n\n🎯 As a maker, you partner with leaders and ICs across the team to get the work done.\n\n🎯 You act as an owner of your team's work, and use data to ensure that goals are being hit.",
    role: "Managers",
  },
  {
    skill: "Achieve Business Results",
    level: "2",
    description: "Achieve Business Results M4\n\n🎯 You are able to show your's and your team's impact (directly or indirectly) as related to company-wide metrics & initiatives.\n\n🎯 As a maker, you partner with leaders and ICs across the team to get the work done.\n\n🎨 You lead design strategies that move company metrics and drive customer success.",
    role: "Managers",
  },
  {
    skill: "Achieve Business Results",
    level: "3",
    description: "Achieve Business Results M5\n\n🎯 You are a key driver counted on for core business metrics.\n\n🎯 As a maker and coach, you drive results directly as well as through other leaders and ICs.\n\n🎨 You identify opportunities where design creates competitive or business advantage.",
    role: "Managers",
  },
  {
    skill: "Achieve Business Results",
    level: "4",
    description: "Achieve Business Results M6\n\n🎯 You are a key driver for core business metrics.\n\n🎯 As a maker and coach, you drive results directly as well as through other leaders and ICs.\n\n🎨 You lead large design initiatives that significantly impact company results.\n\n🎨 You assist with Sales motions (customer workshops, media briefings, etc.) to help Figma close deals.",
    role: "Managers",
  },
  {
    skill: "Achieve Business Results",
    level: "5",
    description: "Achieve Business Results E1\n\n🎯 You are accountable for key business outcomes. You define success metrics at scale and ensure the leaders on your team are aligned, and delivering.\n\n🎯 As a maker, you partner with leaders and ICs across the team to get the work done.\n\n🎨 You champion design, internally and externally, as a core lever for innovation and long-term business performance.",
    role: "Managers",
  },
  {
    skill: "Achieve Business Results",
  ...
  },
  {
    skill: "Collaboration",
    level: "1",
    description: "Collaboration M3\n\n🎯 You build relationships and proactive communication channels with your reports and cross-functional partners.\n\n🎯 With support, you navigate ambiguity and conflict within the team and between teams to drive bigger outcomes.\n\n🎨 You foster open, inclusive design rituals that connect design, product, and engineering and encourage constructive critique.",
    role: "Managers",
  },
  {
    skill: "Collaboration",
    level: "2",
    description: "Collaboration M4\n\n🎯 You influence cross-functional groups as a trusted partner, and execute effectively against the team's plans and goals.\n\n🎯 You proactively surface and confront conflict, addressing directly and coming to the best outcome holistically, not just for your team.\n\n🎨 You lead design collaborations (vision sprints, crits, etc.) that align teams around shared outcomes.",
    role: "Managers",
  },
  {
    skill: "Collaboration",
    level: "3",
    description: "Collaboration M5\n\n🎯 You navigate complex cross-team dependencies and relationships.\n\n🎯 You often manage/guide others who have more domain expertise than you.\n\n🎯 You are able to hold contradicting views at once, remove personal bias and navigate outcomes to be in the best interest of Figma.",
    role: "Managers",
  },
  {
    skill: "Collaboration",
    level: "4",
    description: "Collaboration M6\n\n🎯 You create and leverage relationships with senior leaders throughout the org to drive collaboration cross-functionally.\n\n🎯 You are able to objectively weigh pros and cons of significant conflict and navigate with diplomacy.\n\n🎨 You champion collaboration models that position design as a strategic partner in company direction.",
    role: "Managers",
  },
  {
    skill: "Collaboration",
    level: "5",
    description: "Collaboration E1\n\n🎯 You influence internal and external partners globally to champion the company's strategy and mission.\n\n🎯 You serve as \"deputies\" for the C-level executives.\n\n🎯 You solve complex cross-functional conflicts or problems that impact the company, in partnership with executive leadership.\n\n🎨 You model executive partnership and inclusive leadership that positions design as a driver of innovation.",
    role: "Managers",
  },
  {
    skill: "Collaboration",
  ...
  },
  {
    skill: "Communication",
    level: "1",
    description: "Communication M3\n\n🎯 You actively share your team's work with others\n\n🎯 With support, you connect the work completed by your team to your broader team.\n\n🎯 You are developing your ability to translate and present ideas and plans.\n\n🎨 You use storytelling, visuals, and prototypes to clarify design intent, align partners, and drive decisions.",
    role: "Managers",
  },
  {
    skill: "Communication",
    level: "2",
    description: "Communication M4\n\n🎯 You proactively present to and interface with senior leaders across teams/departments representing the work of your team.\n\n🎯 You actively adjust your communication style with different types of people and situations, communicating with empathy, directly and clearly.\n\n🎯 With support, you gain buy-in for your ideas through concise, compelling asks and storytelling.\n\n🎨 You coach designers to tailor messages to audience needs, connecting user insights to business goals.",
    role: "Managers",
  },
  {
    skill: "Communication",
    level: "3",
    description: "Communication M5\n\n🎯 You often advise on decisions outside of your core area and model clear, empathetic and direct communication for your team and department.\n\n🎯 You give credit to the work of others, whenever appropriate, and speaking to the collective efforts of team.\n\n🎨 You elevate the storytelling quality of design presentations, critiques, and leadership updates.\n\n🎨 You guide senior designers and managers to express design impact in a way that inspires confidence and alignment.",
    role: "Managers",
  },
  {
    skill: "Communication",
    level: "4",
    description: "Communication M6\n\n🎯 You inspire your team with visionary communication, providing purpose and anchoring to the bigger picture.\n\n🎯 You proactively share and coach others to share perspectives cross-functionally.\n\n🎯 You are often presenting at org or company-wide meetings, and need little help in conveying ideas/perspectives\n\n🎨 You represent design's vision and priorities in executive and company-wide forums, as well as external events.",
    role: "Managers",
  },
  {
    skill: "Communication",
    level: "5",
    description: "Communication E1\n\n🎯 You are a senior company spokesperson, both internally and externally.\n\n🎯 You proactively communicate perspectives across the company, including those that may be unpopular opinion, and coach others to do the same.\n\n🎨 You represent Figma's design vision publicly, shaping the industry's understanding of design leadership.",
    role: "Managers",
  },
  {
    skill: "Communication",
  ...
  },
  {
    skill: "Talent",
    level: "1",
    description: "Talent M3\n\n🎯 You are actively involved in your team's hiring processes, including creation of job descriptions and interview panels, partnering with recruiters and interviewers as needed.\n\n🎯 You focus on hiring by reviewing resumes, encouraging referrals, posting on LinkedIn, and reaching out to your network.\n\n🎨 You proactively build your talent pipeline, evaluating design portfolios to understand craft and potential.",
    role: "Managers",
  },
  {
    skill: "Talent",
    level: "2",
    description: "Talent M4\n\n🎯 You are accountable for your team's hiring goals.\n\n🎯 You model effective hiring manager practices and disrupt biases you observe through the hiring and selection process.\n\n🎯 With support, you create effective org designs, which consider the long term balance of your team and representation across your team on all variables (background, skillsets, etc).\n\n🎨 You coach designers to participate effectively in hiring and improve how your team reviews portfolios and conducts design crit interviews.",
    role: "Managers",
  },
  {
    skill: "Talent",
    level: "3",
    description: "Talent M5\n\n🎯 You have a track record of hiring exceptional talent and help close strong candidates across functions.\n\n🎯 You plan how your org will scale over the next year and coach managers on org design and inclusive hiring.\n\n🎨 You identify gaps in design craft, systems thinking, or leadership, and shape hiring strategies to address them.\n\n🎨 You leverage and scale your network to source top design talent for Figma's design team.",
    role: "Managers",
  },
  {
    skill: "Talent",
    level: "4",
    description: "Talent M6\n\n🎯 You build the optimal structure for your organization 2+ years out, and influence org design and/or hiring decisions with partner teams\n\n🎯 You use data to hold your leadership team accountable to hiring exceptional candidates\n\n🎯 You actively champion BEI within hiring searches across the org.\n\n🎯 You play an active role in hiring key leadership roles across Figma.\n\n🎨 You define the bar for design craft and leadership in hiring at scale, ensuring clear and consistent evaluation.",
    role: "Managers",
  },
  {
    skill: "Talent",
    level: "5",
    description: "Talent E1\n\n🎯 You are skilled at understanding the levels and skills that will be needed to grow your org 3+ years into the future.\n\n🎯 You strategically give advice to leaders throughout the organization on how to build representative and efficient teams.\n\n🎯 You hire senior leaders who build functions.\n\n🎨 You set the vision for design hiring quality and help shape how design leadership is evaluated at Figma.\n\n🎨 You elevate Figma's external presence to attract top design talent through thought leadership and strong interviewing culture.",
    role: "Managers",
  },
  {
    skill: "Talent",
  ...
  },
  {
    skill: "Culture",
    level: "1",
    description: "Culture M3\n\n🎯 You are infusing play in your team activities\n\n🎯 You are prioritizing psychological safety and inclusive practices on your team to ensure that everyone feels recognized, appreciated, and comfortable speaking up.\n\n🎨 You reinforce design values by encouraging curiosity, openness in crit, and appreciation for thoughtful craft.\n\n🎨 You shape team rituals that encourage learning, connection, and alignment across design and XFN partners.",
    role: "Managers",
  },
  {
    skill: "Culture",
    level: "2",
    description: "Culture M4\n\n🎯 You have a strong pulse on and strategy around the engagement and retention of your teams.\n\n🎯 You are regularly refining your org strategy, with support from your People Partner, through insights learned from culture and pulse surveys.\n\n🎯 You coach your team on how to create inclusion and psychological safety on their teams. You give constructive, meaningful feedback to others when you see bias, disrupt your own bias, and invite others to hold you accountable.",
    role: "Managers",
  },
  {
    skill: "Culture",
    level: "3",
    description: "Culture M5\n\n🎯 You build inclusive practices and anti-bias throughout your org, and model continuous learning and openness to feedback.\n\n🎨 You promote shared standards for craft and a culture of thoughtful iteration.\n\n🎨 You champion a design culture that values quality, critique, and system-level thinking across the entire product area.",
    role: "Managers",
  },
  {
    skill: "Culture",
    level: "4",
    description: "Culture M6\n\n🎯 You set a cultural standard for your organization, and work with your leadership team to do the same.\n\n🎯 You optimize team operating principles, engagement, effectiveness, and employee experience.\n\n🎯 You scale inclusive practices and anti-bias throughout all levels of your org (e.g., You keep a close pulse on high potential talent within the organization in an effort to pursue appropriate sponsorship).\n\n🎨 You influence XFN leaders to understand and support the cultural needs of a high-performing design org.",
    role: "Managers",
  },
  {
    skill: "Culture",
    level: "5",
    description: "Culture E1\n\n🎯 You and your team are cultural role models for the rest of the company.\n\n🎯 You motivate and energize the team to rally around the department and company goals.\n\n🎯 You are accountable for fostering a company-wide culture of inclusive practices.\n\n🎨 You shape the culture of design at Figma, helping the company understand the impact of great design.\n\n🎨 You amplify the design team's presence externally, positioning Figma as a great place to work at as a designer.",
    role: "Managers",
  },
  {
    skill: "Culture",
  ...
  },
  {
    skill: "Coaching",
    level: "1",
    description: "Coaching M3\n\n🎯 You are communicating job/role expectations with your direct reports\n\n🎯 You are having quarterly development conversations with each of your direct reports to support their career journey, and are consistently seeking feedback about your directs from peers & stakeholders\n\n🎯 You are mediating conflict as it arises within your direct team\n\n🎯 You are proactively looping in your people & employee relations partners to support with any people issues within your team\n\n🎨 You help designers build confidence by guiding them through decisions, feedback, and early ambiguity.",
    role: "Managers",
  },
  {
    skill: "Coaching",
    level: "2",
    description: "Coaching M4\n\n🎯 You hold your directs accountable for managing performance.\n\n🎯 You navigate difficult conversations with others that both get the message across but also strengthen rapport.\n\n🎯 You foster and support development plans to help your team (both directs & skips) reach their potential and career aspirations.\n\n🎯 You offer mentorship and coaching to people who do not directly report to you, both formally and informally.\n\n🎨 You support skill-building across design disciplines, helping individuals grow in craft, product thinking, and collaboration.",
    role: "Managers",
  },
  {
    skill: "Coaching",
    level: "3",
    description: "Coaching M5\n\n🎯 You foster a high-performance and feedback-forward culture across the department through appropriate platforms (e.g., skip-level 1:1s)\n\n🎯 You hold your teams accountable for their performance and results.\n\n🎯 You actively mentor strong leaders and high-performing peers.\n\n🎯 You collaborate with other leaders to ensure individuals across the department are well-leveraged and continuously growing.\n\n🎨 You help managers coach their teams through complex UX and product challenges with clarity and confidence.",
    role: "Managers",
  },
  {
    skill: "Coaching",
    level: "4",
    description: "Coaching M6\n\n🎯 You are coaching other managers on your team and across the company, advising them on management best practices.\n\n🎯 You are a skilled and proactive partner at spotting \"smoke before the fire\" when it comes to potential people issues.\n\n🎨 You enable your design leaders to operate effectively without you always being involved.\n\n🎨 You push your team to engage in external design leadership opportunities (conferences, writing, etc.)",
    role: "Managers",
  },
  {
    skill: "Coaching",
    level: "5",
    description: "Coaching E1\n\n🎯 You are enabling coaching and performance growth for your org at scale.\n\n🎯 You are often coaching high level leaders and presenting to others on growth and development.\n\n🎯 You are exemplifying company-wide standards on coaching, learning and development.\n\n🎨 You define the philosophy of design leadership at Figma and coach leaders on modeling our values in feedback, quality, and growth.\n\n🎨 You represent design leadership standards internally and externally, shaping how Figma grows great design leaders.",
    role: "Managers",
  },
  {
    skill: "Coaching",
  ...
  },
  {
    ...
    level: "1",
    description: "Design Quality M3\n\n🎨 You give clear, actionable craft feedback.\n\n🎨 You step in as a maker when needed to demonstrate expectations or unblock work.\n\n🎨 You ensure work is accurate, on brand, and aligned with guidelines.\n\n🎨 You maintain a steady critique cadence for your team.",
    role: "Managers",
  },
  {
    skill: "Design Quality",
    level: "2",
    description: "Design Quality M4\n\n🎨 You set and uphold a consistent quality bar across multiple teams.\n\n🎨 You coach designers to identify quality gaps and articulate rationale.\n\n🎨 You are recognized cross-functionally as a strong evaluator of design quality.",
    role: "Managers",
  },
  {
    skill: "Design Quality",
    level: "3",
    description: "Design Quality M5\n\n🎨 You push the craft vision quality bar for your pillar.\n\n🎨 You help evolve org-wide quality mechanisms including frameworks, principles, and design reviews.\n\n🎨 You ensure your pillar's design output takes platform-level considerations into account, pushing for cross-pillar collaboration as necessary.",
    role: "Managers",
  },
  {
    skill: "Design Quality",
    level: "4",
    description: "Design Quality M6\n\n🎨 You set craft direction across multiple surface areas and time horizons.\n\n🎨 You raise leadership-level craft taste by coaching managers, senior ICs, and XFN leaders on 'what great looks like'.\n\n🎨 You connect craft decisions to long-term product and business strategy.",
    role: "Managers",
  },
  {
    skill: "Design Quality",
    level: "5",
    description: "Design Quality E1\n\n🎨 You define Figma-wide craft excellence standards.\n\n🎨 You represent world-class design quality externally.\n\n🎨 You ensure multi-product output is coherent across Figma's entire platform.\n\n🎨 You create an environment where craft thrives across the organization.",
    role: "Managers",
  },
  {
    skill: "Design Quality",
  ...
  },
  {
    ...
    level: "1",
    description: "Systems & Process M3\n\n🎨 You establish and run core team rituals such as crits, reviews, and async sharing.\n\n🎨 You ensure strong PM and engineering collaboration and shared clarity on requirements.\n\n🎨 You coach ICs on healthy process habits, documentation, and workflows.\n\n🎨 You begin improving team-level systems and standards.",
    role: "Managers",
  },
  {
    skill: "Systems & Process",
    level: "2",
    description: "Systems & Process M4\n\n🎨 You anticipate dependencies and align cross-team decisions.\n\n🎨 You guide teams on prototyping, research, and validation approaches.\n\n🎨 You influence partners on how design should operate within the product development process.",
    role: "Managers",
  },
  {
    skill: "Systems & Process",
    level: "3",
    description: "Systems & Process M5\n\n🎨 You build multi-team systems that reduce ambiguity and execution friction.\n\n🎨 You drive cross-pillar alignment on workflow and quality gates to achieve multi-product consistency.\n\n🎨 You partner with DesignOps, Research, Data, Design Systems, and PM leadership to shape org-wide practices.",
    role: "Managers",
  },
  {
    skill: "Systems & Process",
    level: "4",
    description: "Systems & Process M6\n\n🎨 You shape long-term operational models for design at scale.\n\n🎨 You lead major systems-level initiatives, such as complex cross-platform patterns.\n\n🎨 You ensure design, research, writing, and systems teams operate cohesively.",
    role: "Managers",
  },
  {
    skill: "Systems & Process",
    level: "5",
    description: "Systems & Process E1\n\n🎨 You define the enterprise operating model for design.\n\n🎨 You enable high-leverage design operations across staffing, frameworks, and cross-org systems.\n\n🎨 You elevate design's role in company-wide planning and execution.",
    role: "Managers",
  },
  {
    skill: "Systems & Process",
  ...
  },
  {
    ...
    level: "1",
    description: "Strategy & Vision M3\n\n🎨 You help ICs clarify goals, constraints, and user needs, knowing when deeper research is needed.\n\n🎨 You facilitate early problem-framing activities and hypothesis development.\n\n🎨 You escalate upstream strategy issues when they impact team direction.",
    role: "Managers",
  },
  {
    skill: "Strategy & Vision",
    level: "2",
    description: "Strategy & Vision M4\n\n🎨 You own vision for a functional area or surface, driving new strategic explorations.\n\n🎨 You coach teams to handle ambiguity and define impactful requirements.\n\n🎨 You align partners on shared direction and evaluate competing paths.",
    role: "Managers",
  },
  {
    skill: "Strategy & Vision",
    level: "3",
    description: "Strategy & Vision M5\n\n🎨 You lead major vision initiatives that influence pillar-level roadmaps.\n\n🎨 You anticipate future opportunities through research, customer signals, and industry insight.\n\n🎨 You align multiple teams around a coherent strategic narrative.",
    role: "Managers",
  },
  {
    skill: "Strategy & Vision",
    level: "4",
    description: "Strategy & Vision M6\n\n🎨 You shape multi-year product strategy for broad surfaces or cross-product experiences.\n\n🎨 You connect design strategy to market direction, and speak on behalf of Figma's product vision externally as appropriate (conferences, speaking engagements, etc.)\n\n🎨 You lead high-ambiguity explorations and identify major strategic bets, helping to shape company-level narrative.",
    role: "Managers",
  },
  {
    skill: "Strategy & Vision",
    level: "5",
    description: "Strategy & Vision E1\n\n🎨 You define company-wide strategic design vision with executive peers.\n\n🎨 You spot long-range industry shifts and position Figma ahead of them.\n\n🎨 You ensure design strategy is integrated into planning and messaging across the organization.",
    role: "Managers",
  },
  {
    skill: "Strategy & Vision",
